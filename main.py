@namespace
class SpriteKind:
    basketball = SpriteKind.create()

def on_on_overlap(sprite, otherSprite):
    info.change_score_by(1)
    mySprite2.set_position(randint(0, 160), randint(120, 10))
    info.start_countdown(3)
sprites.on_overlap(SpriteKind.player, SpriteKind.basketball, on_on_overlap)
